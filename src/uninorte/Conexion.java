...
public class Conexion implements Serializable{	
	...
	public Conexion() {
		//this.serverbd = System.getenv("serverbd");
		this.serverbd = System.getenv("jdbc:mariadb://172.17.9.112:80/eclipse"); 
		this.userbd = System.getenv("eclipse");
		this.passbd = System.getenv("uninorte");
	}
